...
c.InteractiveShellApp.exec_lines.append(
    'print( "Warning: autorelaod enabled, to improve performance disable it in ipython_config.py")'
    )
...
#c.InteractiveShell.banner1 = "Python 3.6.6 (default, Sep  4 2018, 15:00:23) \nType 'copyright', 'credits' or 'license' for more information\nIPython 6.5.0 -- An enhanced Interactive Python. Type '?' for help.\n"
