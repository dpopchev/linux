...
$(UNINSTALL): uninstall-%:
	...
	@$(call RESTORE,$(shell $(call FIND_LATEST_BACKUP,$(filter %$*,$(CONFIGS_DST)))),$(HOME)/.$*)
	@$(call RM,$(DUMMIES)/$*.dummy)

.PHONY: install-vim uninstall-vim-home uninstall-vim
...
# 	@touch $*
#
# $(DUMMIES)/vim_home.dummy:
# 	@$(call MSG_BACKUP,$*)
# 	@$(call MSG_INSTALL,$*)
# 	@touch $*
#
# .PHONY: install-vvim
# install-vvim: $(DUMMIES)/vimrc.dummy $(DUMMIES)/vim.dummy
#
# herefornow:
...
#
# BASHRC_DUMMY := $(DUMMIES)/bashrc.dummy
#
# $(DUMMIES)/%.dummy:
# 	echo $@
# 	touch $@
...
# install-bashrc: $(BASHRC_DUMMY)
# 	@$(call MSG_INSTALL,$*)
#
# BASHRC := bashrc.private bashrc.utils aliases.private
#
